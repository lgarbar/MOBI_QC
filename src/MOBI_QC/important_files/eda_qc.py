...
def eda_qc(filename:str, stim_df:pd.DataFrame=False, event:str=None, outpath:str=None) -> tuple[dict, plt, plt, pd.DataFrame, bool]:
    """
...
if __name__ == "__main__":
    ...
    try:
        eda_qc(filename, stim_df, event=event, outpath=outpath)
    except Exception as e:
